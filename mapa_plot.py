...
plt.plot(unfold5_cum, unfold5_x, label="unfold5", linewidth=2)
plt.plot(no_interp_cum, no_interp_x, label="no_interp", linewidth=2)

plt.xlabel("Cumulative time (s)")
plt.ylabel("Number of solved instances")
plt.title("Cactus Plot: Solver Performance in bags")
...
# === Save to file ===
plt.savefig("cactus_plot_mapa.png", dpi=300)
